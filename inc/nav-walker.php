 ...
 * @package khonsu
 */
class khonsu_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) === 0 && 1 === $depth ) {
			...
			$classes[] = 'khonsu-menu-item menu-item-' . $item->ID;
			...
			$id = apply_filters( 'nav_menu_item_id', 'khonsu-menu-item menu-item-' . $item->ID, $item, $args );
